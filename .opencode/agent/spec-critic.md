---
description: Spec critic - challenges a spec before implementation. Finds ambiguities, contradictions, missing requirements, edge cases, security/backward-compatibility/migration/rollback concerns. Returns STRUCTURED or NEEDS_CLARIFICATION with a question list. Run on non-trivial specs, before planning.
mode: subagent
