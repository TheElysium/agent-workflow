...
- For any slice that adds or moves UI, flag the absence of a visual target (a reference component to reuse, a placement on a named page, or an ASCII mockup confirmed with the user) as NEEDS_CLARIFICATION.
